...
HD_PWD='C:/Users/19896/EGR426_hayejord_Project1/EGR426_hayejord_Project1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Proj1_serialDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proj1_serialDecoder.tcl -notrace
