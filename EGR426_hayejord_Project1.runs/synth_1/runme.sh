...
HD_PWD='C:/Users/19896/EGR426_hayejord_Project1/EGR426_hayejord_Project1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proj1_serialDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proj1_serialDecoder.tcl
